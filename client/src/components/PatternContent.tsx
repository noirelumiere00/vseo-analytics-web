  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="p-3 bg-slate-50 rounded-lg border-l-[3px] border-l-teal-400">
          <div className="text-xs font-semibold text-teal-700 mb-1 flex items-center gap-1.5">
      ...
      <div className="p-3 bg-teal-50 rounded-lg border border-teal-200 border-l-[3px] border-l-teal-600">
        <div className="text-xs font-semibold text-teal-700 mb-1 flex items-center gap-1.5">
...
export function LosePatternContent({ analysis }: { analysis: { summary: string; badHook: string; contentWeakness: string; formatProblems: string; hashtagMistakes: string; avoidTips: string } }) {
  return (
    <div className="space-y-4">
      <div className="p-3 bg-white rounded-lg border-l-[3px] border-l-amber-500 border border-amber-100">
        <p className="text-sm font-medium text-slate-800">{analysis.summary}</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="p-3 bg-amber-50/40 rounded-lg border-l-[3px] border-l-amber-400">
